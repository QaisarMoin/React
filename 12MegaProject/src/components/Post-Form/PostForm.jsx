...
//This is for create and edit of post
  ...
  React.useEffect(() => {
    const subscription = watch((value, { name }) => {
      if (name === "title") {
        ...
        //setValue means that slug mein slughTransform (value.title) store kardena
        //yaha slughtransform mein ham value.title ko pass kar rahe hai
      }
    });
